            ...
            if (isset($_GET['minority'])) {?>
              <?php
                  foreach ($_GET['minority'] as $selected_food) {
                      ?>
              <label class="checkbox__label" for="minority-<?php echo $selected_food ?>">&nbsp
                <?php echo $selected_food ?><input type="checkbox" disabled checked
                  id="minority-<?php echo $selected_food ?>" disabled readonly name="minority[]"
                  value="<?php echo $selected_food ?>" /><span class="checkbox__custom"></span></label>
              <?php
                  }?>
              <?php } else {
                      ?>
            ...
            if (isset($_GET['donate'])) {?>
              <?php
                  foreach ($_GET['donate'] as $selected_food) {
                      ?>
              <label class="checkbox__label" for="donate-<?php echo $selected_food ?>">&nbsp
                <?php echo $selected_food ?><input type="checkbox" id="donate-<?php echo $selected_food ?>" checked
                  disabled readonly name="donate[]" value="<?php echo $selected_food ?>" /><span
            ...
            if (isset($_GET['project'])) {?>
              <?php
                  foreach ($_GET['project'] as $selected_food) {
                      ?>
              <label class="checkbox__label" for="project-<?php echo $selected_food ?>">&nbsp
                <?php echo $selected_food ?><input checked disabled type="checkbox"
                  id="project-<?php echo $selected_food ?>" disabled readonly name="project[]"
                  value="<?php echo $selected_food ?>" /><span class="checkbox__custom"></span></label>
              <?php
                  }?>
              <?php } else {
                      ?>
              <label class="checkbox__label" for="project-no">&nbsp
